...
def renameRand(path):
    ...
    for oldFileNameAndExt in fileList:
        ...
        while newFileName.upper() in existName:
            newFileName = random.choice(rangeLetter) + random.choice(rangeLetter) + str(random.randrange(10))+str(random.randrange(10)) + random.choice(rangeLetter)+str(random.randrange(10)) + existName.append(newFileName.upper())
...
if __name__ == '__main__':
    renameRand(r'F:\Example\Example\Example\Example')
